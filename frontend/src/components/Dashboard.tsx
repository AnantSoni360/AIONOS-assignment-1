...
function SkeletonCard() {
  return (
    <div className="bg-white p-4 rounded-xl border border-gray-100 animate-pulse flex gap-3">
    ...
    return (
      <div className="max-w-6xl mx-auto flex flex-col gap-6">
        ...
        <div className="grid grid-cols-3 gap-8">
          ...
          <div className="col-span-1 bg-white rounded-xl border border-gray-100 h-96 animate-pulse" />
        </div>
      </div>
    );
  }
...
// Arjun Calendar — Board Prep Session: Thu 24 Sep, 09:00–10:00 AM`}
                    ...
                    <div className="flex flex-col gap-2 h-full justify-center">
                      ...
                      {[
                        ...
                        <button key={q}
                          ...
                          className="text-left text-sm px-3 py-2 rounded-lg bg-orange-50 hover:bg-orange-100:bg-orange-900 text-orange-800 border border-orange-100 transition-colors">
                          {q}
                        </button>
                      ))}
                    </div>
                  ...
                  <form onSubmit={handleAsk} className="relative">
                    <input type="text" value={question}
                      ...
                      className={`w-full bg-gray-50 border rounded-full py-2.5 pl-4 pr-20 focus:outline-none focus:ring-2 focus:ring-orange-500 disabled:opacity-50 text-sm transition-all ${
                        isListening ? 'border-red-400 bg-red-50 ring-2 ring-red-300' : 'border-gray-200'
                      }`}
                    />
                    <button type="button"
                      ...
                      className={`absolute right-10 top-1.5 p-1.5 rounded-full transition-all disabled:opacity-40 ${
                        isListening ? 'bg-red-500 text-white animate-pulse shadow-lg shadow-red-300' : 'bg-gray-200 text-gray-600 hover:bg-gray-300'
                      }`}>
      ...
      {selectedCommitment && activeTab === 'dashboard' && (
        <div className="fixed inset-0 bg-black/20 flex justify-end z-50">
          <div className="bg-white w-[450px] h-full shadow-2xl p-6 flex flex-col">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-bold">Commitment Details</h2>
              <button onClick={() => setSelectedCommitment(null)} className="p-2 hover:bg-gray-100:bg-gray-800 rounded-full">
                <X className="w-5 h-5" />
              </button>
            </div>
